...
int main()
{
	...
	while (1) {
		...
		case 3:
		case 4:return 0;
		default:cout << "Please input number 1 to 4 to choose . please try again .\n"; continue;
		}
	}
	return 0;
}
...
/*int main()
{
	...
	else if (tempnumber == 1)
	{
		...
		while (1)//以后把这边改成判断胜负的函数或者条件
		{
			...
			//执行落子
			putchess(startX, startY, resultX, resultY, obstacleX, obstacleY, currBotColor);
